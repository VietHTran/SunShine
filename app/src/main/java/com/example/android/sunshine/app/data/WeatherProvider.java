...
//            case WEATHER_WITH_LOCATION:
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (matcher) {
            ...
            case LOCATION: {
                rowId=database.delete(WeatherContract.LocationEntry.TABLE_NAME,selection,selectionArgs);
                break;
            }
            default:{
                throw new UnsupportedOperationException("Unknown uri: " + uri);
    ...
    public int update(
        ...
        switch (matcher) {
            case WEATHER: {
                rowId=database.update(WeatherContract.WeatherEntry.TABLE_NAME,values,selection,selectionArgs);
                break;
            }
            case LOCATION: {
                rowId=database.update(WeatherContract.LocationEntry.TABLE_NAME,values,selection,selectionArgs);
                break;
            }
            default:{
                throw new UnsupportedOperationException("Unknown uri: " + uri);
